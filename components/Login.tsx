      ...
      <div className="w-full max-w-sm md:w-1/2">
        <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-10 text-center">
          <div className="flex justify-center mb-6">
            <h1 className="text-4xl font-serif text-zinc-100 tracking-wider">SocialSnap</h1>
          </div>
          ...
          {isLoginView ? (
            <>
              ...
              <div className="flex items-center my-6">
                <div className="h-px bg-zinc-600 flex-grow"></div>
                <div className="px-4 text-sm font-semibold text-zinc-400">OR</div>
                <div className="h-px bg-zinc-600 flex-grow"></div>
              </div>

              <button className="flex items-center justify-center w-full text-sm font-semibold text-blue-400 mb-4 hover:text-blue-300 transition-colors">
            ...
            <>
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-3">
                ...
                <p className="text-xs text-zinc-400 py-2">
                  People who use our service may have uploaded your contact information to SocialSnap. <a href="#" className="text-blue-400 hover:underline">Learn More</a>
                </p>
                <p className="text-xs text-zinc-400 pb-2">
                  By signing up, you agree to our <a href="#" className="text-blue-400 hover:underline">Terms</a> , <a href="#" className="text-blue-400 hover:underline">Privacy Policy</a> and <a href="#" className="text-blue-400 hover:underline">Cookies Policy</a>.
                </p>
        ...
        <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 mt-4 text-center">
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-zinc-200">Get the app.</p>
